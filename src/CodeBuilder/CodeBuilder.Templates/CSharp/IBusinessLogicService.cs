namespace X3Platform.CodeBuilder.Templates.CSharp
{
    ...
    public class IBusinessLogicService : CSharpGenerator
    {
        ...
        public override void Init(string taskName, CodeBuilderConfiguration configuration)
        {
            ...
            {
                configuration.Tasks[taskName].Properties.Add(new X3Platform.CodeBuilder.Configuration.TaskProperty("File", configuration.Tasks[taskName].Properties["InterfaceName"].Value + ".cs"));
            }
        ...
        public override string PrintCode()
        {
            ...
            return VelocityManager.Instance.ParseTemplateVirtualPath(context,
                X3Platform.Util.StringHelper.NullOrEmptyTo(TemplateFile, "templates/CSharp/IBusinessLogicService.vm"));
        }
        #endregion
    }
}
